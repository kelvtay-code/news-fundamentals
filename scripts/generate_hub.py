...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  @media (max-width: 700px) {{
    ...
    nav.section-nav {{ padding-left:20px; padding-right:20px; }}
    .masthead-inner {{ padding-top:8px; padding-bottom:6px; gap:6px; }}
    .masthead-eyebrow {{ display:none; }}
    .masthead-title {{ font-size:1.15rem; }}
    .freshness-panel {{ gap:8px; padding-top:0; }}
    .fresh-dot {{ width:8px; height:8px; }}
    .fresh-item {{ gap:5px; }}
    .fresh-label {{ display:none; }}
    .fresh-ts {{ font-size:0.62rem; }}
    nav.section-nav button {{ padding:8px 10px; font-size:10px; }}
  }}
</style>
</head>
<body>
